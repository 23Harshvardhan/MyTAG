...
export class EditCardComponent implements OnInit {
  ...
  updateLinkLogos() {
    ...
    axios.put('http://185.208.207.55/v1/api/activities/card_data/updatelinklogo?id=' + this.cardID + '&userID=' + this.data.UserID, formdata, this.cookie)
    .then((response) => {
  ...
  updateCardImages() {
    ...
    axios.put('http://185.208.207.55/v1/api/activities/card_data/updatecardimage?id=' + this.cardID + '&userID=' + this.data.UserID, formdata, this.cookie)
    .then((response) => {
      let imageUrls: string[] = response.data.paths.map(path => {
        let values = Object.values(path);
        return "http://185.208.207.55/v1/" + values[0];
  ...
  uploadImage() {
    ...
    if(this.compressedImage != null) {
      ...
      axios.put('http://185.208.207.55/v1/api/activities/card_data/updatebanner?id=' + this.cardID, formdata, this.cookie)
      .then((response) => {
        this.uploadLogo();
      })
      .catch((error) => {
  ...
  uploadLogo() {
    ...
    if(this.compressedImage2 != null) {
      ...
      axios.put('http://185.208.207.55/v1/api/activities/card_data/updatelogo?id=' + this.cardID, formdata, this.cookie)
      .then((response) => {
