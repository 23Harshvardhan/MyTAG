...
export class AdminSettingsComponent implements OnInit {
  ...
  changeRootPass(creds : {Email:string, Username:string, Password:string, NewPassword:string}) {
    axios.put('http://34.70.242.122/v1/api/admin/updatepassword', creds, this.cookie)
    .then((response) => {
  ...
  verifyUser(details: {UserID:string, Email:string, verification:string}) {
    console.log(details);
    axios.put('http://34.70.242.122/v1/api/admin/updateuser/verify', details, this.cookie)
    .then((response) => {
